...
class GestionCajaController extends RecaudacionController
{
	...
	//APERTURA CAJA
	public function gestionAbrirCajaAction(Request $request)
	{
		...
		return $this->redirect($this->generateUrl('recaudacion_recaudacion', array('tipoPago' => $tipoPago)));
	}
	...
	public function gestionCerrarCajaAction(request $request, $id)
	{
		...
		return $this->render('RecaudacionBundle:Recaudacion/GestionCaja:formularioCerrarCaja.html.twig', array(
