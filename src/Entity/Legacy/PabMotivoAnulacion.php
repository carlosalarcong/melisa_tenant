 ...
 * PabMotivoAnulacion
 *
 * @ORM\Table(name="pab_motivo_anulacion")
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="Rebsol\HermesBundle\Repository\PabMotivoAnulacionRepository")
 */
class PabMotivoAnulacion
{
    /**
     * @var int
     *
