 ...
 * TarjetaCreditoTipo
 *
 * @ORM\Table(name="tarjeta_credito_tipo")
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="Rebsol\HermesBundle\Repository\TarjetaCreditoTipoRepository")
 */
class TarjetaCreditoTipo
{
    /**
     * @var int
     *
