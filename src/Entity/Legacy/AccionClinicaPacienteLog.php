 ...
 *
 * @ORM\Table(name="accion_clinica_paciente_log")
 * @ORM\Entity

 */
class AccionClinicaPacienteLog
{
    /**
     * @var int
     *
     ...
     * @var int
     *
     * @ORM\Column(name="ID_ACCION_CLINICA_PACIENTE", type="integer", nullable=false)
     */
    ...
    /**
     * @param int $idAccionClinicaPaciente
     */
    public function setIdAccionClinicaPaciente($idAccionClinicaPaciente)
    {
