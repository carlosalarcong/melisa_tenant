 ...
 * PabCausaSuspension
 *
 * @ORM\Table(name="pab_causa_suspension")
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="Rebsol\HermesBundle\Repository\PabCausaSuspensionRepository")
 */
class PabCausaSuspension
{
    /**
     * @var int
     *
