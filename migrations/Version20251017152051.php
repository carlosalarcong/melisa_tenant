 ...
 */
final class Version20251017152051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Religion (id INT AUTO_INCREMENT NOT NULL, id_estado INT DEFAULT NULL, nombre VARCHAR(100) NOT NULL, codigo VARCHAR(20) NOT NULL, descripcion LONGTEXT DEFAULT NULL, activo TINYINT(1) DEFAULT 1 NOT NULL, INDEX IDX_E92396AF6A540E (id_estado), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Sexo (id INT AUTO_INCREMENT NOT NULL, id_estado INT DEFAULT NULL, nombre VARCHAR(50) NOT NULL, codigo VARCHAR(10) NOT NULL, activo TINYINT(1) DEFAULT 1 NOT NULL, INDEX IDX_8C0BF9AC6A540E (id_estado), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE Religion ADD CONSTRAINT FK_E92396AF6A540E FOREIGN KEY (id_estado) REFERENCES estado (id)');
        $this->addSql('ALTER TABLE Sexo ADD CONSTRAINT FK_8C0BF9AC6A540E FOREIGN KEY (id_estado) REFERENCES estado (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Religion DROP FOREIGN KEY FK_E92396AF6A540E');
        $this->addSql('ALTER TABLE Sexo DROP FOREIGN KEY FK_8C0BF9AC6A540E');
