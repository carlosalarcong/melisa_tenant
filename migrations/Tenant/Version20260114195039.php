 ...
 */
final class Version20260114195039 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `member` ADD CONSTRAINT FK_70E4FA785D83CC1 FOREIGN KEY (state_id) REFERENCES state (id)');
        ...
        $this->addSql('ALTER TABLE person ADD CONSTRAINT FK_34DCD1767949DE26 FOREIGN KEY (nacionality_id) REFERENCES pais (id)');
        $this->addSql('CREATE INDEX IDX_34DCD17632C8A3DE ON person (organization_id)');
        $this->addSql('ALTER TABLE person_address ADD CONSTRAINT FK_2FD0DC08F92F3E70 FOREIGN KEY (country_id) REFERENCES pais (id)');
        $this->addSql('ALTER TABLE region ADD CONSTRAINT FK_F62F176F92F3E70 FOREIGN KEY (country_id) REFERENCES pais (id)');
        $this->addSql('ALTER TABLE sexo CHANGE nombre name VARCHAR(50) NOT NULL, CHANGE codigo code VARCHAR(10) NOT NULL, CHANGE activo is_active TINYINT(1) DEFAULT 1 NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sexo CHANGE name nombre VARCHAR(50) NOT NULL, CHANGE code codigo VARCHAR(10) NOT NULL, CHANGE is_active activo TINYINT(1) DEFAULT 1 NOT NULL');
    }
}
